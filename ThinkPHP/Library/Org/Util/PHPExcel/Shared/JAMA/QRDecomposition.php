...
class PHPExcel_Shared_JAMA_QRDecomposition {
	...
	*/
	...
	/**
	 *	QR Decomposition computed by Homeer reflections.
	 *
	 *	@param matrix $A Rectangular matrix
	 *	@return Structure to access R and the Homeer vectors and compute Q.
	 */
