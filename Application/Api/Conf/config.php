...
return array(
    ...
    'SKIPACTIONS'=>'regioncode,get_access_token,callbackaddress,get_loupan,get_loupanlbs,nearest_subway,get_streetcode,get_siglepage',//不进行鉴权的接口方法
    'DEFAULT_FILTER' => 'htmlspecialcharsx',
    
    'UEDITOR_CONFIG' => array(//百度编辑器配置
        ...
        "imagePathFormat" => "/Uploads/image/###/{yyyy}-{mm}-{dd}/{time}{rand:6}",  /* {filename} 会替换成原文件名,配置这项需要注意中文乱码问题 */
