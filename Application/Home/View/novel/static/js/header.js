...
function login(){
//document.writeln("<div class=\"ywtop\"><div class=\"ywtop_con\"><B>公告：</B>本网站基于YGBOOK v3.0系统搭建，感谢使用。请您牢记本站网址，感谢大家的支持！<button onclick=\"window.open('http://i.0rg.pw');\" style=\"color:red\">了解详情</button></span>");
...
//document.writeln("<p>Copyright &copy; 2010-2016 powered by YGBOOK v3.0. <button onclick=\"window.open('http://i.0rg.pw');\" style=\"color:red\">了解详情</button></p>");
...
//document.writeln("<div class=\"userpanel\" onclick=\"window.open('http://i.0rg.pw');\">&nbsp;<font color=\"red\">YGBOOK v3.0<br>http://i.0rg.pw</font></div>");
//}
//function list_panel(){
//document.writeln("<div class=\"header_search\"><form name=\"form\" action=\"http://zhannei.baidu.com/cse/search\" method=\"get\" id=\"sform\" target=\"_blank\"><input type=\"hidden\" name=\"s\" value=\"287293036948159515\"><input type=\"text\" placeholder=\"可搜书名，请您少字也别输错字\" value=\"\" name=\"q\" class=\"search\" id=\"wd\" baiduSug=\"2\" /><button id=\"sss\" type=\"submit\"> 搜 索 </button></form></div>");
//document.writeln("<div class=\"userpanel\" onclick=\"window.open('http://i.0rg.pw');\">&nbsp;<font color=\"red\">YGBOOK v3.0<br>http://i.0rg.pw</font></div>");
